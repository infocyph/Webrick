...
- `Attribute Routes <./attributes.rst>`__ - Declare routes with PHP attributes
- `Groups & Domains <./groups-and-domains.rst>`__ - Organize routes with prefixes and domain scoping
- `Responses <./responses.rst>`__ - Response helpers reference
- `URLs <./urls.rst>`__ - Generate and secure URLs
