...
- 👉 `Matcher <./matcher.rst>`__
- 👉 `Route Cache <./route-cache.rst>`__
- 👉 `Response Emitters <./emitters.rst>`__
- 👉 `Enums <./enums.rst>`__
- 👉 Request/Response: see the dedicated request and response references. Webrick offers PSR-7-style methods but does not implement the PSR-7 interfaces.
