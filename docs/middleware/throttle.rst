...
Pass any application-provided PSR-6 pool to use throttling without CacheLayer. Install a supported CacheLayer release only when using the default local pool or its atomic counter backend:
